...
<pre>
Reset done. The cache for <a href='${wikiTask.getServer()}${wikiTask.getScriptpath()}'>${wikiTask.getServer()}</a>
has been cleared by a call from <a href='${wikiTask.getServer()}${wikiTask.getScriptpath()}/index.php/${wikiTask.getPageTitle()}'>${wikiTask.getPageTitle()}</a>
</pre>
    </div>
